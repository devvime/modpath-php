  ...
  public function dispatch(): void
  {
    foreach ($this->routes as $route) {
      ...
      if (preg_match($regex, $this->requestPath, $matches)) {
        ...
        MiddlewareManager::verify($route['middlewares'], $request, $response);
        MiddlewareManager::verify($route['guards'], $request, $response);
        MiddlewareManager::verify($route['dtos'], $request, $response);
